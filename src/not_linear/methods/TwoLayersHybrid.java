...
public class TwoLayersHybrid
{
    ...
    private double[] progonkaSquare(final int m, final double[] stroka, final double tao)
    {
        ...
        while (true)
        {
            ...
            if (iter <= this.parametrs.getMaxIterProgonka())
            {
            ...
            if (norma_XnPlus <= this.parametrs.geteSystemSquare() || iter > this.parametrs.getMaxIterBigDecimal())
            {
    ...
    private double[] progonkaCube(final int m, final double[] stroka, final double tao, final double[] x_m_stroka)
    {
        ...
        while (true)
        {
            ...
            if (norma_XnPlus <= parametrs.geteSystemCube() || iter > this.parametrs.getMaxIterBigDecimal())
            {
